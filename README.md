...
Is someone singing right now? (Voice Activity Detection / VAD)



What pitch are they singing? (360 per-bin sigmoid scores covering 6 octaves)
...
Mel spectrograms + RMVPE pitch posteriorgrams + VAD



GTSinger 1 (9 languages)
...
Mel spectrograms of environmental noise
...
Pre-mixed test clips at 6 noise levels



Clean + noise at -5, 0, 5, 10, 20 dB, and clean
...
Fraction of frames with correct voice/silence label
...
Voicing Detection Rate — of truly voiced frames, how many detected?
...
Raw Pitch Accuracy — of voiced frames, how many within 50 cents?
...
Raw Chroma Accuracy — same as RPA but ignoring octave errors
...
Gross error rate — frames with pitch error > 50 cents
...
Median pitch error in cents (100 cents = 1 semitone)
...
Positive weighting. Pass pos_weight to nn.BCEWithLogitsLoss to upweight voiced frames:
...
Focal loss 8. Focal loss multiplies the per-example BCE by (1 − p_t)^γ, automatically down-weighting easy negatives (clear silence) and concentrating the gradient on hard examples (ambiguous onset/offset frames). With γ = 2 and a voiced-positive weight, this often tightens VAD boundaries noticeably:
...
Balanced sampling. Instead of uniform random clip sampling in NanoPitchDataset.__getitem__, sample with probability proportional to the voiced-frame fraction of each segment. This ensures each batch contains a mix of high-activity and low-activity clips.
...
**training/model.py** — understand the neural network architecture, pitch representation, and Viterbi decoding



**training/train.py** — training loop; implement augment_mel_batch for noise mixing



**training/evaluate.py** — understand the evaluation metrics and offline vs realtime comparison



**deployment/export_weights.py** — how PyTorch weights become a JSON file for the browser



**deployment/wasm/nanopitch.c** — how the same model runs in C (mel FFT, GRU cells, Viterbi)



**deployment/web/index.html** — how the browser captures audio and runs WASM inference
...
1. First Model: Clean noise training only (without Augment_mel_batch)

NanoPitch: 332,873 parameters (cond=64, gru=96)
Evaluating: 100%|████████████████████████████████| 600/600 [00:21<00:00, 28.05clip/s]
...
========================================================================
  ...
  ──────────  ────────  ────────  ────────  ────────  ────────  ────────
  -5 dB          78.8%     54.9%     88.7%     89.8%     11.3%      67.1
  +0 dB          81.0%     61.1%     92.1%     92.2%      7.9%      14.6
  +5 dB          83.2%     66.5%     91.1%     91.2%      8.9%      43.2
  +10 dB         90.0%     66.0%     93.4%     93.4%      6.6%      36.7
  +20 dB         88.8%     66.6%     94.8%     94.8%      5.2%      10.3
  clean          98.8%     83.2%     95.7%     96.1%      4.3%       7.7
  ──────────  ────────  ────────  ────────  ────────  ────────  ────────
  overall        86.8%     66.4%     92.7%     93.0%      7.3%      29.1
...
========================================================================
  ...
  Condition    VAD Acc       VDR       RPA       RCA     Gross     Med.¢
  ──────────  ────────  ────────  ────────  ────────  ────────  ────────
  -5 dB          78.8%     54.4%     85.2%     86.2%     14.8%      73.3
  +0 dB          81.0%     59.9%     88.2%     89.1%     11.8%      44.9
  +5 dB          83.2%     65.4%     89.6%     89.7%     10.4%      43.3
  +10 dB         90.0%     65.1%     91.6%     91.7%      8.4%      36.6
  +20 dB         88.8%     65.5%     92.5%     92.5%      7.5%      10.8
  clean          98.8%     81.5%     95.0%     95.4%      5.0%       7.6
  ──────────  ────────  ────────  ────────  ────────  ────────  ────────
  overall        86.8%     65.3%     90.5%     90.9%      9.5%      35.3

  600 clips evaluated
  Metrics: VAD Acc = voice activity accuracy
           VDR = voicing detection rate (recall)
           RPA = raw pitch accuracy (within 50 cents)
           RCA = raw chroma accuracy (octave-invariant, circular 1200¢ distance)
           Gross = gross pitch error rate (>50 cents)
           Med.¢ = median pitch error in cents
  Offline Viterbi = global optimum (backtrace)
  Realtime Viterbi  = greedy (matches browser deployment)

2. Second Model: Basic augment mel batch with loggdexxp mixing noise and clean data.

NanoPitch: 332,873 parameters (cond=64, gru=96)
Evaluating: 100%|████████████████████████████████| 600/600 [00:31<00:00, 18.85clip/s]
...
========================================================================
  ...
  Condition    VAD Acc       VDR       RPA       RCA     Gross     Med.¢
  ──────────  ────────  ────────  ────────  ────────  ────────  ────────
  -5 dB          93.8%     57.3%     90.7%     90.9%      9.3%      25.8
  +0 dB          92.3%     58.8%     88.0%     88.3%     12.0%      61.1
  +5 dB          93.6%     60.7%     89.9%     90.0%     10.1%      35.6
  +10 dB         95.6%     64.2%     92.9%     93.0%      7.1%      17.7
  +20 dB         96.7%     66.7%     91.4%     91.4%      8.6%      42.8
  clean          97.5%     66.0%     94.3%     94.4%      5.7%      13.1
  ──────────  ────────  ────────  ────────  ────────  ────────  ────────
  overall        94.9%     62.3%     91.2%     91.3%      8.8%      33.0
...
========================================================================
  ...
  Condition    VAD Acc       VDR       RPA       RCA     Gross     Med.¢
  ──────────  ────────  ────────  ────────  ────────  ────────  ────────
  -5 dB          93.8%     56.6%     88.4%     88.6%     11.6%      26.0
  +0 dB          92.3%     58.1%     86.8%     87.2%     13.2%      60.4
  +5 dB          93.6%     60.3%     88.6%     88.7%     11.4%      32.2
  +10 dB         95.6%     63.4%     91.6%     91.7%      8.4%      18.2
  +20 dB         96.7%     66.2%     88.8%     88.9%     11.2%      37.2
  clean          97.5%     66.1%     92.5%     92.6%      7.5%      13.6
  ──────────  ────────  ────────  ────────  ────────  ────────  ────────
  overall        94.9%     61.8%     89.4%     89.6%     10.6%      31.4
  ...
  Evaluated in 31.9s
Per-clip results saved to second.csv

1st Run vs 2nd Run

From what I understood from 1st and 2nd, 1st when trained on only CleanMel, pitch recognition was better but (VAD accuracy not so good especially for noisy environment)

Whereas in second model trained on mixed mel data, VAD accuracy was much better however, this resulted in worse comparisions for VDR, RPA, RCA and Gross.

Classic precision vs recall

If somehow can use these models in concatenation (Like pitch training using clean data and noise training using mixed data) would be great

3. Third Model: Frequency Masking only F = 6 on training mixed mel
